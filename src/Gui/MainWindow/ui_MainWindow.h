...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/hexagon"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutHexagonAction = new QAction(MainWindow);
        m_aboutHexagonAction->setObjectName(QStringLiteral("m_aboutHexagonAction"));
        m_aboutHexagonAction->setEnabled(true);
...
//        menuHelp->addAction(m_reportIssueAction);
        menuHelp->addAction(m_aboutHexagonAction);
        ...
        QObject::connect(m_aboutHexagonAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutHexagonAction->setText(QApplication::translate("MainWindow", "About Hexagon", Q_NULLPTR));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND HEXAGON", Q_NULLPTR));
